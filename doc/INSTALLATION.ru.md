...
Этот способ позволяет установить репозиторий напрямую из интернета без загрузки файла на компьютер.

### Прямая установка ZIP из URL

⚠️ **Важно:** Сначала разрешите установку из неизвестных источников (см. ниже).
...
**Альтернативный URL (если GitHub Pages активирован):**
```
