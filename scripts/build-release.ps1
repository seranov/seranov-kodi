...
Write-Info ""
Write-Info "3. GitHub Actions will automatically:"
Write-Info "   - Build all addons"
Write-Info "   - Create ZIP archives"
Write-Info "   - Deploy to GitHub Pages"
Write-Info ""
Write-Info "4. After deployment, users can install the repository from:"
Write-Info "   https://seranov.github.io/seranov-kodi/repository.seranov.zip"
Write-Info ""
...
Write-Info "  1. Download: https://seranov.github.io/seranov-kodi/repository.seranov.zip"
Write-Info "  2. In Kodi: Settings → Add-ons → Install from zip file"
Write-Info "  3. Select the downloaded ZIP file"
Write-Info ""
Write-Info "Method 2: Repository will auto-update after installation"
Write-Info "  The repository URL is configured in addon.xml and points to GitHub Pages"
Write-Info ""
